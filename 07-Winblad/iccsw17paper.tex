...
\volumeinfo%(easychair interface)
  {}% editors
  {0}% number of editors: 1, 2, ....
  {2017 Imperial College Computing Student Workshop (ICCSW 2017)}% event To appear in the proceedings of 
  {3}% volume
  {1}% issue
...
\begin{wrapfigure}[13]{r}{.315\textwidth}
%\begin{figure}[t]
  %\wrapfigtopfix
  \centering
...
%The reduction of the amount of time which is spent on traversing shared mutable data obtained from this optimization As the time that range queries need to spend on traversing the data structure is at least linear in the number of items in the range, this optimization can give a reduction of the time range qureis spend on reading shared mutable data which is .
%This optimization can can
%The linearization point of an optimized read operation remains as without the optimization; see~\cite{CATreeISPDC,CATreeLCPC}. %% after which all locks have been acquired or when the first sequence number scan has completed in a successful optimistic attempt.
...
%%   \subfloat[\textsf{w:3\% r:27\% q:50\%-$R$ u:20\%-$R$}]{
%%     \begin{tabular}{ccccc} \hline
%%       $R$ & 10 & 100 & 1000 & 10000 \\ \hline
%%       CA-SL & 14.4 & 8.8 & 4.0 & 2.5 \\
%%       CA-AVL & 15.6 & 8.7 & 3.6 & 2.2 \\ \hline
%%     \end{tabular}
%%     \label{tab:node_counts:R}
%%   }
%%   \hspace{2em}
%%   \subfloat[\textsf{w:3\% r:27\% q:50\%-1000 u:20\%-1000}]{
%%     \begin{tabular}{ccccccc} \hline
%%       threads & 2 & 4 & 8 & 16 & 32 & 64 \\ \hline
%%       CA-SL & 0.36 & 0.73 & 1.2 & 1.9 & 2.7 & 4.0 \\
%%       CA-AVL & 0.34 & 0.68 & 1.1 & 1.6 & 2.4 & 3.6 \\ \hline
%%     \end{tabular}
%%     \label{tab:node_counts:threads}
%%   } \\[.5em]
%%   \caption{Average base node counts (in $k$) at the end of running two sets of benchmarks: one using
%%     64~threads but varying the range size~$R$, and one varying the number of threads.}
...
\begin{figure}[b]
  ...
  \newcommand{\graphheight}{.22\textheight}
  \subfloat[\textsf{w:20\% r:55\% q:25\%-10}]{ 
    \includegraphics[width=0.31\textwidth]{{{benchmark_graphs/no@3@10@3@10@ALL@100000@50000@0.55@0.25@10@0.0@0}}} 
    \label{fig:randr10:100000}
  }
  \subfloat[\textsf{w:20\% r:55\% q:25\%-1000}]{
    \includegraphics[width=0.325\textwidth]{{{benchmark_graphs/no@3@10@3@10@ALL@100000@50000@0.55@0.25@1000@0.0@0}}}
    \label{fig:randr1000:100000}
  }
  \subfloat[\textsf{w:20\% r:55\% q:25\%-100000}]{
    \includegraphics[width=0.315\textwidth]{{{benchmark_graphs/no@3@10@3@10@ALL@100000@50000@0.55@0.25@100000@0.0@0}}}
    \label{fig:randr100000:100000}
  }
