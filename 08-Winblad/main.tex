...
% \EventLogo{../graphics/iccsw17}%please provide filename (without suffix)
...
The new data structure is based on the contention adapting search tree (CA tree)~\cite{CATreeISPDC, CATreeLCPC, JPDCCAtree} and an immutable data structure.
...
The reader is referred to the earlier papers on CA trees~\cite{CATreeISPDC,CATreeLCPC,JPDCCAtree} for a detailed description including pseudo-code and arguments that their operations provide linearizability, deadlock freedom, and livelock freedom.
